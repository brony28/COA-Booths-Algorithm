...
# Finds 2's compliment of the value
...
#Assigning sign to binary number
...
#Add operation of 2 binary numbers
def Add(valA,valM):
	add = []
	ad = valA
	carry = 0
...
print("Multiplicand (M) :",*msign)
print("Multiplier (Q) : ",*qsign)
...
while counter > 0:
	...
	new_Qneg1=a[len(rr):]
	print("Step",step,"     ",*newA,"     ",*newQ,"        ",*new_Qneg1)
...
#rrsult is AQ
result=newA+newQ
if(result[0]==1): #if MSB of result = 1, means result is neagtive. So take 2's compliment and write the final value
